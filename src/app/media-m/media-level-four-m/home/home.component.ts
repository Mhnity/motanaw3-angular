...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //first term
       this.store_service.media_levfour_firTerm().subscribe(data =>{
    ...
    //second term
    this.store_service.media_levfour_secTerm().subscribe(data =>{
    ...
    /******************* start typeit ******/
      new TypeIt("#big_media_four", {
        strings: "الفرقة الرابعة ",
        speed:100,
        cursor: false,
      }).go();
      new TypeIt("#small_media_four", {
        strings: " اعلام تربوي ",
        speed:100,
        cursor: false,
        startDelay: 1800
