...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //first term
       this.store_service.media_levone_firTerm().subscribe(data =>{
    ...
    //second term
    this.store_service.media_levone_secTerm().subscribe(data =>{
    ...
    /******************* start typeit ******/
      new TypeIt("#big_media_one", {
        strings: "الفرقة الاولي ",
        speed:100,
        cursor: false,
      }).go();
      new TypeIt("#small_media_one", {
        strings: " اعلام تربوي ",
        speed:100,
        cursor: false,
        startDelay: 1800
