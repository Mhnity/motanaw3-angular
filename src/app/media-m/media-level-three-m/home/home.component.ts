...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //first term
       this.store_service.media_levthree_firTerm().subscribe(data =>{
    ...
    //second term
    this.store_service.media_levthree_secTerm().subscribe(data =>{
    ...
    /******************* start typeit ******/
      new TypeIt("#big_media_three", {
        strings: "الفرقة الثالثة ",
        speed:100,
        cursor: false,
      }).go();
      new TypeIt("#small_media_three", {
        strings: " اعلام تربوي ",
        speed:100,
        cursor: false,
        startDelay: 1800
