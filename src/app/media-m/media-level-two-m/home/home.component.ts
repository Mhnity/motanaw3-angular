...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //first term
       this.store_service.media_levtwo_firTerm().subscribe(data =>{
    ...
    //second term
    this.store_service.media_levtwo_secTerm().subscribe(data =>{
    ...
    /******************* start typeit ******/
      new TypeIt("#big_media_two", {
        strings: "الفرقة الثانية ",
        speed:100,
        cursor: false,
      }).go();
      new TypeIt("#small_media_two", {
        strings: " اعلام تربوي ",
        speed:100,
        cursor: false,
        startDelay: 1800
