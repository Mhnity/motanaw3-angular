...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //first term
       this.store_service.stage_levtwo_firTerm().subscribe(data =>{
    ...
    //second term
    this.store_service.stage_levtwo_secTerm().subscribe(data =>{
    ...
    /******************* start typeit ******/
      new TypeIt("#big_stage_two", {
        strings: "الفرقة الثانية ",
        speed:100,
        cursor: false,
      }).go();
      new TypeIt("#small_stage_two", {
        strings: " مسرح ",
        speed:100,
        cursor: false,
        startDelay: 1800
