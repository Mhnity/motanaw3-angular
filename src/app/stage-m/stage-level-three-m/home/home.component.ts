...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //first term
       this.store_service.stage_levthree_firTerm().subscribe(data =>{
    ...
    //second term
    this.store_service.stage_levthree_secTerm().subscribe(data =>{
    ...
    /******************* start typeit ******/
      new TypeIt("#big_stage_three", {
        strings: "الفرقة الثالثة ",
        speed:100,
        cursor: false,
      }).go();
      new TypeIt("#small_stage_three", {
        strings: " مسرح ",
        speed:100,
        cursor: false,
        startDelay: 1800
