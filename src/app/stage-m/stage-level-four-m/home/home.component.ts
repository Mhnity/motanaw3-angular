...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //first term
       this.store_service.stage_levfour_firTerm().subscribe(data =>{
    ...
    //second term
    this.store_service.stage_levfour_secTerm().subscribe(data =>{
    ...
    /******************* start typeit ******/
      new TypeIt("#big_satge_four", {
        strings: "الفرقة الرابعة ",
        speed:100,
        cursor: false,
      }).go();
      new TypeIt("#small_satge_four", {
        strings: " مسرح ",
        speed:100,
        cursor: false,
        startDelay: 1800
