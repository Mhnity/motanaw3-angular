...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //first term
       this.store_service.tech_levone_firTerm().subscribe(data =>{
    ...
    //second term
    this.store_service.tech_levone_secTerm().subscribe(data =>{
    ...
    /******************* start typeit ******/
      new TypeIt("#big_tech_one", {
        strings: "الفرقة الاولي ",
        speed:100,
        cursor: false,
      }).go();
      new TypeIt("#small_tech_one", {
