...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //first term
       this.store_service.tech_levthree_firTerm().subscribe(data =>{
    ...
    //second term
    this.store_service.tech_levthree_secTerm().subscribe(data =>{
    ...
    /******************* start typeit ******/
      new TypeIt("#big_tech_three", {
        strings: "الفرقة الثالثة ",
        speed:100,
        cursor: false,
      }).go();
      new TypeIt("#small_tech_three", {
        strings: " تكنولوجيا التعليم ",
        speed:100,
        cursor: false,
        startDelay: 1800
      }).go();
