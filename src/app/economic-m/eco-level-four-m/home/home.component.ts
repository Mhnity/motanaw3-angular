...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //first term
       ...
       this.store_service.economic_levfour_firTerm().subscribe(data =>{
    ...
    //second term
    this.store_service.economic_levfour_secTerm().subscribe(data =>{
    ...
    /******************* start typeit ******/
      new TypeIt("#big_eco_four", {
        strings: "الفرقة الرابعة ",
        speed:100,
        cursor: false,
      }).go();
      new TypeIt("#small_eco_four", {
