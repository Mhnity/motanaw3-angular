...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //first term
       this.store_service.economic_levthree_firTerm().subscribe(data =>{
    ...
    //second term
    this.store_service.economic_levthree_secTerm().subscribe(data =>{
    ...
    /******************* start typeit ******/
      new TypeIt("#big_eco_three", {
        strings: "الفرقة الثالثة ",
        speed:100,
        cursor: false,
      }).go();
      new TypeIt("#small_eco_three", {
        strings: " اقصاد منزلي ",
        speed:100,
        cursor: false,
        startDelay: 1800
