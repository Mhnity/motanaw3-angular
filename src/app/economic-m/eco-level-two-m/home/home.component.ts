  ...
  ngOnInit() {
    ...
    //first term
      ...
      $(function(){
       ...
       this.store_service.economic_levtwo_firTerm().subscribe(data =>{
    ...
    //second term
    this.store_service.economic_levtwo_secTerm().subscribe(data =>{
    ...
    /******************* start typeit ******/
      new TypeIt("#big_eco_two", {
        strings: "الفرقة الثانية ",
        speed:100,
        cursor: false,
      }).go();
      new TypeIt("#small_eco_two", {
        strings: " اقصاد منزلي ",
        speed:100,
        cursor: false,
        startDelay: 1800
