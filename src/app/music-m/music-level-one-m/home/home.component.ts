...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //first term
       this.store_service.music_levone_firTerm().subscribe(data =>{
    ...
    //second term
    this.store_service.music_levone_secTerm().subscribe(data =>{
    ...
    /******************* start typeit ******/
      new TypeIt("#big_music_one", {
        strings: "الفرقة الاولي ",
        speed:100,
        cursor: false,
      }).go();
      new TypeIt("#small_music_one", {
