...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //first term
       this.store_service.music_levfour_firTerm().subscribe(data =>{
    ...
    //second term
    this.store_service.music_levfour_secTerm().subscribe(data =>{
    ...
    /******************* start typeit ******/
      new TypeIt("#big_music_four", {
        strings: "الفرقة الرابعة ",
        speed:100,
        cursor: false,
      }).go();
      new TypeIt("#small_music_four", {
