...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //first term
       this.store_service.music_levthree_firTerm().subscribe(data =>{
    ...
    //second term
    this.store_service.music_levthree_secTerm().subscribe(data =>{
    ...
    /******************* start typeit ******/
      new TypeIt("#big_music_three", {
        strings: "الفرقة الثالثة ",
        speed:100,
        cursor: false,
      }).go();
      new TypeIt("#small_music_three", {
        strings: " تربية موسيقية  ",
        speed:100,
        cursor: false,
        startDelay: 1800
      }).go();
