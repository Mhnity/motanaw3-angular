...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //first term
       this.store_service.music_levtwo_firTerm().subscribe(data =>{
    ...
    //second term
    this.store_service.music_levtwo_secTerm().subscribe(data =>{
    ...
    /******************* start typeit ******/
      new TypeIt("#big_music_two", {
        strings: "الفرقة الثانية ",
        speed:100,
        cursor: false,
      }).go();
      new TypeIt("#small_music_two", {
