...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //first term
       this.store_service.computer_levfour_firTerm().subscribe(data =>{
    ...
    //second term
    this.store_service.computer_levfour_secTerm().subscribe(data =>{
