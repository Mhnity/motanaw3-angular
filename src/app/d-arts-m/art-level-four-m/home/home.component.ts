...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //first term
       this.store_service.art_levfour_firTerm().subscribe(data =>{
    ...
    //second term
    this.store_service.art_levfour_secTerm().subscribe(data =>{
    ...
    /******************* start typeit ******/
      new TypeIt("#big_art_four", {
        strings: "الفرقة الرابعة ",
        speed:100,
        cursor: false,
      }).go();
      new TypeIt("#small_art_four", {
        strings: " تربية فنية ",
        speed:100,
        cursor: false,
        startDelay: 1800
