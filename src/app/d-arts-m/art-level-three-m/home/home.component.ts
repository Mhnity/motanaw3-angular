...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //first term
       this.store_service.art_levthree_firTerm().subscribe(data =>{
    ...
    //second term
    this.store_service.art_levthree_secTerm().subscribe(data =>{
    ...
    /******************* start typeit ******/
      new TypeIt("#big_art_three", {
        strings: "الفرقة الثالثة ",
        speed:100,
        cursor: false,
      }).go();
      new TypeIt("#small_art_three", {
        strings: " تربية فنية ",
        speed:100,
        cursor: false,
        startDelay: 1800
