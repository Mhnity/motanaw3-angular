...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //first term
       this.store_service.art_levtwo_firTerm().subscribe(data =>{
    ...
    //second term
    this.store_service.art_levtwo_secTerm().subscribe(data =>{
    ...
    /******************* start typeit ******/
      new TypeIt("#big_art_two", {
        strings: "الفرقة الثانية ",
        speed:100,
        cursor: false,
      }).go();
      new TypeIt("#small_art_two", {
        strings: " تربية فنية ",
        speed:100,
        cursor: false,
        startDelay: 1800
