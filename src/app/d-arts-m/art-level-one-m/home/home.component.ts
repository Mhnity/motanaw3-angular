...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //first term
       this.store_service.art_levone_firTerm().subscribe(data =>{
    ...
    //second term
    this.store_service.art_levone_secTerm().subscribe(data =>{
    ...
    /******************* start typeit ******/
      new TypeIt("#big_art_one", {
        strings: "الفرقة الاولي ",
        speed:100,
        cursor: false,
      }).go();
      new TypeIt("#small_art_one", {
        strings: " تربية فينة ",
        speed:100,
        cursor: false,
        startDelay: 1800
